...
HD_PWD='C:/Users/jacky/Desktop/EECS_LAB_TRAINING/EECS_LAB_TRAINING/lab2/hdl/TRAIN_TOUR/TRAIN_TOUR.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log TT.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source TT.tcl -notrace
