...
HD_PWD='C:/Users/jacky/Desktop/EECS_LAB_TRAINING/EECS_LAB_TRAINING/lab2/hdl/TRAIN_TOUR/TRAIN_TOUR.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log TT.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source TT.tcl
